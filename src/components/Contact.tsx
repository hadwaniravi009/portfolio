...
export default function Contact() {
  ...
  return (
    <section className="py-24 bg-white" id="contact">
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        {/* Left Column Info */}
        <div className="lg:col-span-5">
          <span className="text-xs font-bold uppercase tracking-widest text-[#0051d5] mb-2 block">
            Get In Touch
          </span>
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-[#000000] mb-6 leading-tight">
            Let's build your next digital masterpiece.
          </h2>
          <p className="text-lg text-[#444748] mb-10 leading-relaxed">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 group">
              <div className="w-12 h-12 rounded-xl bg-[#f2f4f6] flex items-center justify-center text-[#0051d5] group-hover:bg-[#0051d5] group-hover:text-white transition-colors">
        ...
        {/* Right Column Form */}
        <div className="lg:col-span-7 bg-[#f8f9fb] p-8 md:p-12 rounded-3xl border border-[#c4c7c7]/40 shadow-sm">
          {status === 'success' && (
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6" suppressHydrationWarning>
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold uppercase tracking-widest text-[#444748]">
                Name *
              </label>
              <input
                type="text"
                ...
                className="w-full bg-white border border-[#c4c7c7]/60 p-4 rounded-xl focus:ring-2 focus:ring-[#0051d5] focus:border-transparent outline-none transition-all text-sm"
              />
            </div>
            ...
            <div className="flex flex-col gap-2 md:col-span-2">
              ...
              <select
                ...
                suppressHydrationWarning
                className="w-full bg-white border border-[#c4c7c7]/60 p-4 rounded-xl focus:ring-2 focus:ring-[#0051d5] focus:border-transparent outline-none transition-all text-sm appearance-none cursor-pointer"
              >
            ...
            <button
              ...
              suppressHydrationWarning
              className="md:col-span-2 bg-[#000000] text-white py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-[#0051d5] transition-all active:scale-[0.98] shadow-lg flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
            >
              {status === 'submitting' ? (
                <>
